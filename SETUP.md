...
## 0. 페이지 구성
- `index.html` 메인(웨딩 시네마) · `profile/` 프로필 · `schedule/` 일정(캘린더) · `dress/` 옷장 · `work/` 업보 · `ticket/` 시참권 · `stamp/` 스탬프 · `guide/` 안내(게시판) · `admin/` 관리자 콘솔
...
- 📖 안내: 방송 규칙/시참 규칙/가이드 게시판 — 자체 에디터(제목·굵게·기울임·밑줄·취소선·글자색 6·형광펜 3·구분선·인용·접기 토글·이미지·링크), 📌 고정, ✎ 수정, 🔗 글별 공유 링크 복사(`guide/?p=번호`)
- 📮 편지함: 문의 확인/삭제
