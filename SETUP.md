...
## 0. 페이지 구성
- `index.html` 메인(웨딩 시네마) · `profile/` 프로필 · `schedule/` 일정(캘린더) · `dress/` 옷장 · `work/` 업보 · `ticket/` 시참권 · `stamp/` 스탬프 · `guide/` 안내(게시판 · 글 검색) · `admin/` 관리자 콘솔
...
## 6. 배포 확인법 (버전 스탬프)
- 지금 배포된 게 최신인지 확인: 브라우저에서 **F12 → Console** 열면 `LEE YEDA site build 20260725a` 가 찍혀요.
- 관리자 페이지 맨 아래에도 `PRIVATE CONSOLE · BUILD 20260725a` 로 표시돼요.
